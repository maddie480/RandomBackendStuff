...
import com.max480.randomstuff.backend.discord.questcommunitybot.admin.PingCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.admin.ShutdownCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.admin.UptimeCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.gamestats.*;
import com.max480.randomstuff.backend.discord.questcommunitybot.leveling.*;
import com.max480.randomstuff.backend.discord.questcommunitybot.misc.*;
import com.max480.randomstuff.backend.discord.questcommunitybot.quest.*;
import com.max480.randomstuff.backend.discord.questcommunitybot.random.*;
import com.max480.randomstuff.backend.discord.questcommunitybot.reminders.AddReminderCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.reminders.ListRemindersCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.reminders.ReminderEngine;
import com.max480.randomstuff.backend.discord.questcommunitybot.reminders.RemoveReminderCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.search.GoogleImageSearchCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.search.GoogleSearchCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.search.WikipediaCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.search.YouTubeSearchCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.ytdlp.YoutubeDlAudioCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.ytdlp.YoutubeDlCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.ytdlp.YoutubeDlRandomCommand;
import com.max480.randomstuff.backend.discord.questcommunitybot.ytdlp.YoutubeDlSponsorBlockCommand;
import com.max480.randomstuff.backend.twitch.CommandParser;
